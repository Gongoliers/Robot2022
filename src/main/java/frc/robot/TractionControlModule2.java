 ...
 */
public class TractionControlModule2 implements DriveModule {
     ...
     */
    public TractionControlModule2(EncoderSensor leftEncoder, EncoderSensor rightEncoder, double strength, double slipThreshold, double turn){
        super();
        mLeftEncoder = leftEncoder;
        mRightEncoder = rightEncoder;
        mStrength = strength;
        mSlipThreshold = slipThreshold;
        mTurningThreshold = turn;
    }
