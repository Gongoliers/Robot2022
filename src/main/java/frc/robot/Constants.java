...
public final class Constants {
  ...
  public static final class EndgameConstants {
    ...
    public static final int kLeftMotorCAN = 21; // LEFT OF BATTERY (WHEN STANDING BEHIND BATTERY)
    public static final int kRightMotorCAN = 20; // RIGHT OF BATTERY (WHEN STANDING BEHIND BATTERY)
    ...
    public static final double kRaiseMotorSpeed = 0.4;
    public static final double kLowerMotorSpeed = -0.5;
  }
}
